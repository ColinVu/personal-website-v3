...
//   },
  ...
  },
  {
    ...
    description: `
      ...
      <ul>
        ...
        <li>Compiled and visualized <strong>DOT</strong> data</li>
      </ul>
    `,
      images: [
    ]
  ...
  },
  {
    ...
    description: 'Researched and analyzed how NASA/IBM’s Prithvi model could be used to model land use outcomes in Ukraine post-war.',
    images: [
    ]
  },
  {
    ...
    description: `
      Made an Android Crossy Road clone with smart enemy seeking and collision mechanics.
      <br>
      <ul>
  ...
  },
  {
    ...
    description: `
      i was having trouble not doom scrolling on instagram reels and i saw a reel of chaewon telling me to lock in so overnight i coded an android app that gives you a pop-up of the video
      <br>
      <ul>
  ...
  },
  {
    ...
    <br>
      <ul>
        <li>shaded w/ <strong>phong shading</strong>, also had <strong>ray tracing</strong> but it fried by PC</li>
